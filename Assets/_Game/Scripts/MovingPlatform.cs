...
public class MovingPlatform : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)//gan player vao platform
    {
    ...
    private void OnCollisionExit2D(Collision2D collision)//huy gan player vao platform
    {
        if (collision.gameObject.CompareTag("Player"))
        {
